...
const std::string   types::HEADER_VARY("Vary");
const std::string   types::HEADER_UPGRADE("Vary");
const std::string   types::HEADER_UPGRADE_INSECURE_REQUESTS("Upgrade-Insecure-Requests");
